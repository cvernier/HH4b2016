{
  ...
  HbbHbb_LMRSelection_chi2("Signal", "BulkGravTohhTohbbhbb_narrow_M-1000_13TeV-madgraph", 1000, true );
  HbbHbb_LMRSelection_chi2("Signal", "BulkGravTohhTohbbhbb_narrow_M-1200_13TeV-madgraph", 1200, true );
}
