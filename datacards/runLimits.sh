...
do
	echo "mass point $i"
	cd /uscms_data/d3/cvernier/4b/HbbHbb_2016/HbbHbb_Run2/Datacards/35p9fb_deepCSVM_rereco/LMR_$i
...
do
        echo "mass point $i"
        cd /uscms_data/d3/cvernier/4b/HbbHbb_2016/HbbHbb_Run2/Datacards/35p9fb_deepCSVM_rereco/MMR_$i
        text2workspace.py datacard_$i\.txt  -o datacard_$i\.root
