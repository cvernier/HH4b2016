...
v_files.push_back(new TFile("PreselectedWithoutRegressionDeepCSV/MMRSelection_chi2/Histograms_MMR_GluGluToBulkGravitonToHHTo4B_M-750_narrow_13TeV-madgraph.root"));
v_files.push_back(new TFile("PreselectedWithoutRegressionDeepCSV/MMRSelection_chi2/Histograms_MMR_GluGluToBulkGravitonToHHTo4B_M-900_narrow_13TeV-madgraph.root"));
...
v_files_reg.push_back(new TFile("PreselectedWithRegressionDeepCSV/MMRSelection_chi2/Histograms_MMR_GluGluToBulkGravitonToHHTo4B_M-750_narrow_13TeV-madgraph.root"));
v_files_reg.push_back(new TFile("PreselectedWithRegressionDeepCSV/MMRSelection_chi2/Histograms_MMR_GluGluToBulkGravitonToHHTo4B_M-900_narrow_13TeV-madgraph.root"));

TFile *f_data_reg=new TFile("PreselectedWithRegressionDeepCSV/Histograms_Preselected_BTagTotal.root");
std::vector <double> mean_gen={300, 450, 600, 750, 900 };
  ...
  g_sigma_H2->Draw("A*");
  c_H1H2_meanSigma->SaveAs("c_H1H2_meanSigma.pdf");
  ...
  leg->Draw();
  c_meanDiff->SaveAs("c_meanDiff.pdf");
  ...
  v_files_reg1.push_back(new TFile("PreselectedWithRegressionDeepCSV/Histograms_GluGluToBulkGravitonToHHTo4B_M-300_narrow_13TeV-madgraph.root"));
  v_files_reg1.push_back(new TFile("PreselectedWithRegressionDeepCSV/Histograms_GluGluToBulkGravitonToHHTo4B_M-450_narrow_13TeV-madgraph.root"));
  v_files_reg1.push_back(new TFile("PreselectedWithRegressionDeepCSV/Histograms_GluGluToBulkGravitonToHHTo4B_M-600_narrow_13TeV-madgraph.root"));
  v_files_reg1.push_back(new TFile("PreselectedWithRegressionDeepCSV/Histograms_GluGluToBulkGravitonToHHTo4B_M-750_narrow_13TeV-madgraph.root"));
  v_files_reg1.push_back(new TFile("PreselectedWithRegressionDeepCSV/Histograms_GluGluToBulkGravitonToHHTo4B_M-900_narrow_13TeV-madgraph.root"));
  ...
  for (unsigned int i=0; i<v_files_reg1.size(); ++i)
  {
    TH1* h = DisplayHistogram_forFile(v_files_reg1.at(i), "h_pTOrder_JetpT_1", v_colors.at(i));
  ...
  DisplayHistogram_forFile(f_data_reg, "h_pTOrder_JetpT_1", kBlack);
  DisplayHistogram_forFile(f_data_reg, "h_pTreg_JetpT_1", kBlack, true);
  leg->AddEntry(f_data_reg->Get("h_pTOrder_JetpT_1"), "13 TeV Data");
  leg->Draw();
  ...
  first=true;
  DisplayHistogram_forFile(f_data_reg, "h_pTOrder_JetpT_2", kBlack);
  DisplayHistogram_forFile(f_data_reg, "h_pTreg_JetpT_2", kBlack, true);
  for (unsigned int i=0; i<v_files_reg1.size(); ++i)
  {
    DisplayHistogram_forFile(v_files_reg1.at(i), "h_pTOrder_JetpT_2", v_colors.at(i));
  ...
  first=true;
  DisplayHistogram_forFile(f_data_reg, "h_pTOrder_JetpT_3", kBlack);
  DisplayHistogram_forFile(f_data_reg, "h_pTreg_JetpT_3", kBlack, true);  
  for (unsigned int i=0; i<v_files_reg1.size(); ++i)
  {
    DisplayHistogram_forFile(v_files_reg1.at(i), "h_pTOrder_JetpT_3", v_colors.at(i));
  ...
  first=true;
  DisplayHistogram_forFile(f_data_reg, "h_pTOrder_JetpT_4", kBlack);
  DisplayHistogram_forFile(f_data_reg, "h_pTreg_JetpT_4", kBlack, true);  
  for (unsigned int i=0; i<v_files_reg1.size(); ++i)
  {
    DisplayHistogram_forFile(v_files_reg1.at(i), "h_pTOrder_JetpT_4", v_colors.at(i));
