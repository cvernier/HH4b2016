...
void drawBias_MMR(const double signal_strenght=1.0, std::string Filename="", std::string background="") {
    ...
    c2->cd();
    leg->Draw("same");
    c2->SaveAs(Form("%s__strenght_%s.pdf",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c2->SaveAs(Form("%s__strenght_%s.png",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c2->SaveAs(Form("%s__strenght_%s.root",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c2a->cd();
    leg2->Draw("same");
    ...
    c3->cd();
    leg3->Draw("same");
    c3->SaveAs(Form("%s__strenght_%s_sigma.pdf",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c3->SaveAs(Form("%s__strenght_%s_sigma.png",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c3->SaveAs(Form("%s__strenght_%s_sigma.root",background.c_str(),(ftoa(signal_strenght)).c_str()));
    c3a->cd();
    leg4->Draw("same");
