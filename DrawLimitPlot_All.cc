...
g_xsec_1sigma_1->SetLineColorAlpha(kGreen,0.5);
g_xsec_1sigma_1->SetFillColorAlpha(kGreen,0.5);
TGraphAsymmErrors *g_xsec_2sigma_1=new TGraphAsymmErrors(nPoints_1, &(mass_1[0]), xsec_1, 0, 0, expNeg2_1, expPos2_1);
g_xsec_2sigma_1->SetLineColorAlpha(kYellow,0.5);
g_xsec_2sigma_1->SetFillColorAlpha(kYellow,0.5);
...
g_xsec_1sigma_2->SetLineColorAlpha(kGreen, 0.5);
g_xsec_1sigma_2->SetFillColorAlpha(kGreen, 0.5);
TGraphAsymmErrors *g_xsec_2sigma_2=new TGraphAsymmErrors(nPoints_2, &(mass_2[0]), xsec_2, 0, 0, expNeg2_2, expPos2_2);
g_xsec_2sigma_2->SetLineColorAlpha(kYellow, 0.5);
g_xsec_2sigma_2->SetFillColorAlpha(kYellow, 0.5);
